...
# 配置文件夹路径
ckpt=[1000,5000,10000,20000,30000,40000]
img_dir='sd-model-fine-tuned-new2'

ori_folders=['data/aligned/alignment/align_size(572,572)_move(0.250,0.000)_face_factor(0.450)/data',os.path.join(img_dir,'output')]
folders=[os.path.join(img_dir,f'checkpoint-{str(i)}','output') for i in ckpt]

output_image_path = "output_image1.jpg"  # 拼接后的输出路径
